...
"""autogenerated by genpy from sagittarius_object_color_detector/SGRCtrlActionResult.msg. Do not edit."""
import codecs
import sys
...
class SGRCtrlActionResult(genpy.Message):
  _md5sum = "10fe34f9d89528ff30d84010f9a4c7a0"
  _type = "sagittarius_object_color_detector/SGRCtrlActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','sagittarius_object_color_detector/SGRCtrlResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SGRCtrlActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = sagittarius_object_color_detector.msg.SGRCtrlResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = sagittarius_object_color_detector.msg.SGRCtrlResult()
