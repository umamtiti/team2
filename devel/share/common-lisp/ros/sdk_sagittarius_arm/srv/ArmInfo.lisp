...
;//! \htmlinclude ArmInfo-request.msg.html

(cl:defclass <ArmInfo-request> (roslisp-msg-protocol:ros-message)
  ()
)

(cl:defclass ArmInfo-request (<ArmInfo-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ArmInfo-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ArmInfo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sdk_sagittarius_arm-srv:<ArmInfo-request> is deprecated: use sdk_sagittarius_arm-srv:ArmInfo-request instead.")))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ArmInfo-request>) ostream)
  "Serializes a message object of type '<ArmInfo-request>"
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ArmInfo-request>) istream)
  "Deserializes a message object of type '<ArmInfo-request>"
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ArmInfo-request>)))
  "Returns string type for a service object of type '<ArmInfo-request>"
  "sdk_sagittarius_arm/ArmInfoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ArmInfo-request)))
  "Returns string type for a service object of type 'ArmInfo-request"
  "sdk_sagittarius_arm/ArmInfoRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ArmInfo-request>)))
  "Returns md5sum for a message object of type '<ArmInfo-request>"
  "8cbf67af7802be3e000262518104df12")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ArmInfo-request)))
  "Returns md5sum for a message object of type 'ArmInfo-request"
  "8cbf67af7802be3e000262518104df12")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ArmInfo-request>)))
  "Returns full string definition for message of type '<ArmInfo-request>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ArmInfo-request)))
  "Returns full string definition for message of type 'ArmInfo-request"
  (cl:format cl:nil "# Get robot information~%#~%# Note that all data that is returned in a vector is organized such that each index~%# corresponds to the joint at the same index as it appears in the joint_states topic.~%# Gripper info is not included in the vectors.~%#~%# Multiple types of robot information are provided, including:~%#   1) joint_names - the names of all joints in the robot~%#   2) joint_ids - the Dynamixel IDs for all joints in the robot~%#   3) lower_joint_limits - the lower joint limits in radians (taken from URDF)~%#   4) upper_joint_limits - the upper joint limits in radians (taken from URDF)~%#   5) velocity_limits - the velocity limits in rad/s (taken from URDF)~%#   6) lower_gripper_limit - the lower gripper limit in radians (taken from URDF)~%#   7) upper_gripper_limit - the upper gripper limit in radians (taken from URDF)~%#   8) use_gripper - True if the driver node can control the gripper - otherwise, False~%#   9) home_pos - home position for each robot; essentially commands all joints~%#                 (excluding gripper) to 0 radians (taken from arm_poses.h)~%#   10) sleep_pos - sleep position for each robot; essentially commands all joints~%#                   (excluding gripper) to a specific position in radians so that~%#                   if the driver node is shutdown (which torques off all motors),~%#                   the arm doesn't come crashing down (taken from arm_poses.h)~%#   11) num_joints - the number of joints in the arm (excluding gripper)~%#   12) num_single_joints - the number of all joints in the robot (includes gripper and any 'single' joints)~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ArmInfo-request>))
  (cl:+ 0
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ArmInfo-request>))
  "Converts a ROS message object to a list"
  (cl:list 'ArmInfo-request
))
;//! \htmlinclude ArmInfo-response.msg.html

(cl:defclass <ArmInfo-response> (roslisp-msg-protocol:ros-message)
  ((joint_names
    :reader joint_names
    :initarg :joint_names
...
(cl:defclass ArmInfo-response (<ArmInfo-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ArmInfo-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ArmInfo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sdk_sagittarius_arm-srv:<ArmInfo-response> is deprecated: use sdk_sagittarius_arm-srv:ArmInfo-response instead.")))

(cl:ensure-generic-function 'joint_names-val :lambda-list '(m))
(cl:defmethod joint_names-val ((m <ArmInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdk_sagittarius_arm-srv:joint_names-val is deprecated.  Use sdk_sagittarius_arm-srv:joint_names instead.")
  (joint_names m))

(cl:ensure-generic-function 'joint_ids-val :lambda-list '(m))
(cl:defmethod joint_ids-val ((m <ArmInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdk_sagittarius_arm-srv:joint_ids-val is deprecated.  Use sdk_sagittarius_arm-srv:joint_ids instead.")
  (joint_ids m))

(cl:ensure-generic-function 'lower_joint_limits-val :lambda-list '(m))
(cl:defmethod lower_joint_limits-val ((m <ArmInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdk_sagittarius_arm-srv:lower_joint_limits-val is deprecated.  Use sdk_sagittarius_arm-srv:lower_joint_limits instead.")
  (lower_joint_limits m))

(cl:ensure-generic-function 'upper_joint_limits-val :lambda-list '(m))
(cl:defmethod upper_joint_limits-val ((m <ArmInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdk_sagittarius_arm-srv:upper_joint_limits-val is deprecated.  Use sdk_sagittarius_arm-srv:upper_joint_limits instead.")
  (upper_joint_limits m))

(cl:ensure-generic-function 'velocity_limits-val :lambda-list '(m))
(cl:defmethod velocity_limits-val ((m <ArmInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdk_sagittarius_arm-srv:velocity_limits-val is deprecated.  Use sdk_sagittarius_arm-srv:velocity_limits instead.")
  (velocity_limits m))

(cl:ensure-generic-function 'lower_gripper_limit-val :lambda-list '(m))
(cl:defmethod lower_gripper_limit-val ((m <ArmInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdk_sagittarius_arm-srv:lower_gripper_limit-val is deprecated.  Use sdk_sagittarius_arm-srv:lower_gripper_limit instead.")
  (lower_gripper_limit m))

(cl:ensure-generic-function 'upper_gripper_limit-val :lambda-list '(m))
(cl:defmethod upper_gripper_limit-val ((m <ArmInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdk_sagittarius_arm-srv:upper_gripper_limit-val is deprecated.  Use sdk_sagittarius_arm-srv:upper_gripper_limit instead.")
  (upper_gripper_limit m))

(cl:ensure-generic-function 'use_gripper-val :lambda-list '(m))
(cl:defmethod use_gripper-val ((m <ArmInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdk_sagittarius_arm-srv:use_gripper-val is deprecated.  Use sdk_sagittarius_arm-srv:use_gripper instead.")
  (use_gripper m))

(cl:ensure-generic-function 'home_pos-val :lambda-list '(m))
(cl:defmethod home_pos-val ((m <ArmInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdk_sagittarius_arm-srv:home_pos-val is deprecated.  Use sdk_sagittarius_arm-srv:home_pos instead.")
  (home_pos m))

(cl:ensure-generic-function 'sleep_pos-val :lambda-list '(m))
(cl:defmethod sleep_pos-val ((m <ArmInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdk_sagittarius_arm-srv:sleep_pos-val is deprecated.  Use sdk_sagittarius_arm-srv:sleep_pos instead.")
  (sleep_pos m))

(cl:ensure-generic-function 'num_joints-val :lambda-list '(m))
(cl:defmethod num_joints-val ((m <ArmInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdk_sagittarius_arm-srv:num_joints-val is deprecated.  Use sdk_sagittarius_arm-srv:num_joints instead.")
  (num_joints m))

(cl:ensure-generic-function 'num_single_joints-val :lambda-list '(m))
(cl:defmethod num_single_joints-val ((m <ArmInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdk_sagittarius_arm-srv:num_single_joints-val is deprecated.  Use sdk_sagittarius_arm-srv:num_single_joints instead.")
  (num_single_joints m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ArmInfo-response>) ostream)
  "Serializes a message object of type '<ArmInfo-response>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ArmInfo-response>) istream)
  "Deserializes a message object of type '<ArmInfo-response>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ArmInfo-response>)))
  "Returns string type for a service object of type '<ArmInfo-response>"
  "sdk_sagittarius_arm/ArmInfoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ArmInfo-response)))
  "Returns string type for a service object of type 'ArmInfo-response"
  "sdk_sagittarius_arm/ArmInfoResponse")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ArmInfo-response>)))
  "Returns md5sum for a message object of type '<ArmInfo-response>"
  "8cbf67af7802be3e000262518104df12")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ArmInfo-response)))
  "Returns md5sum for a message object of type 'ArmInfo-response"
  "8cbf67af7802be3e000262518104df12")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ArmInfo-response>)))
  "Returns full string definition for message of type '<ArmInfo-response>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ArmInfo-response)))
  "Returns full string definition for message of type 'ArmInfo-response"
  (cl:format cl:nil "# joint names appear in the same order as they do in the joint_states.name vector~%string[] joint_names~%int16[] joint_ids~%float64[] lower_joint_limits~%float64[] upper_joint_limits~%float64[] velocity_limits~%float64 lower_gripper_limit~%float64 upper_gripper_limit~%bool use_gripper~%float64[] home_pos~%float64[] sleep_pos~%int8 num_joints~%int8 num_single_joints~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ArmInfo-response>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ArmInfo-response>))
  "Converts a ROS message object to a list"
  (cl:list 'ArmInfo-response
...
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'ArmInfo)))
  'ArmInfo-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'ArmInfo)))
  'ArmInfo-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ArmInfo)))
  "Returns string type for a service object of type '<ArmInfo>"
  "sdk_sagittarius_arm/ArmInfo")