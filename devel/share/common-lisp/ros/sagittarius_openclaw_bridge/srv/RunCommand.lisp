...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RunCommand-request>)))
  ...
  "edabe0f39a90863c1a0eae298fff34ae")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RunCommand-request)))
  "Returns md5sum for a message object of type 'RunCommand-request"
  "edabe0f39a90863c1a0eae298fff34ae")
...
(cl:defclass <RunCommand-response> (roslisp-msg-protocol:ros-message)
  ((success
   ...
   (detected_count
    ...
    :initform 0)
   (detected_colors
    :reader detected_colors
    :initarg :detected_colors
...
(cl:defmethod detected_count-val ((m <RunCommand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sagittarius_openclaw_bridge-srv:detected_count-val is deprecated.  Use sagittarius_openclaw_bridge-srv:detected_count instead.")
  (detected_count m))

(cl:ensure-generic-function 'detected_colors-val :lambda-list '(m))
(cl:defmethod detected_colors-val ((m <RunCommand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sagittarius_openclaw_bridge-srv:detected_colors-val is deprecated.  Use sagittarius_openclaw_bridge-srv:detected_colors instead.")
  (detected_colors m))

(cl:ensure-generic-function 'target_xs-val :lambda-list '(m))
(cl:defmethod target_xs-val ((m <RunCommand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sagittarius_openclaw_bridge-srv:target_xs-val is deprecated.  Use sagittarius_openclaw_bridge-srv:target_xs instead.")
  (target_xs m))

(cl:ensure-generic-function 'target_ys-val :lambda-list '(m))
(cl:defmethod target_ys-val ((m <RunCommand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sagittarius_openclaw_bridge-srv:target_ys-val is deprecated.  Use sagittarius_openclaw_bridge-srv:target_ys instead.")
  (target_ys m))

(cl:ensure-generic-function 'target_zs-val :lambda-list '(m))
(cl:defmethod target_zs-val ((m <RunCommand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sagittarius_openclaw_bridge-srv:target_zs-val is deprecated.  Use sagittarius_openclaw_bridge-srv:target_zs instead.")
  (target_zs m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RunCommand-response>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'detected_colors))))
  ...
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) ele))
   (cl:slot-value msg 'detected_colors))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'target_xs))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let ((bits (roslisp-utils:encode-double-float-bits ele)))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream)))
   (cl:slot-value msg 'target_xs))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'target_ys))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let ((bits (roslisp-utils:encode-double-float-bits ele)))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream)))
   (cl:slot-value msg 'target_ys))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'target_zs))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RunCommand-response>) istream)
  ...
  (cl:setf (cl:slot-value msg 'detected_colors) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'detected_colors)))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'target_xs) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'target_xs)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'target_ys) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'target_ys)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'target_zs) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'target_zs)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RunCommand-response>)))
  ...
  (cl:format cl:nil "bool success~%int32 result_code~%string message~%string detected_color~%float64 target_x~%float64 target_y~%float64 target_z~%int32 detected_count~%string[] detected_colors~%float64[] target_xs~%float64[] target_ys~%float64[] target_zs~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RunCommand-response)))
  "Returns full string definition for message of type 'RunCommand-response"
  (cl:format cl:nil "bool success~%int32 result_code~%string message~%string detected_color~%float64 target_x~%float64 target_y~%float64 target_z~%int32 detected_count~%string[] detected_colors~%float64[] target_xs~%float64[] target_ys~%float64[] target_zs~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RunCommand-response>))
  (cl:+ 0
     ...
     8
     4
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'detected_colors) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4 (cl:length ele))))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'target_xs) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'target_ys) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'target_zs) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <RunCommand-response>))
  ...
  (cl:list 'RunCommand-response
    ...
    (cl:cons ':detected_colors (detected_colors msg))
    (cl:cons ':target_xs (target_xs msg))
    (cl:cons ':target_ys (target_ys msg))
    (cl:cons ':target_zs (target_zs msg))
))
